...
Kiahuho Sacco
    ...
    <link rel="shortcut icon" href="main/images/logo.jpg">
...
<body>
	'<div style="color: BLUE; text-align: center;"" font:bold 44px 'Aleo';> WELCOME TO NAPALLONNE SACCO</p>
...
<div class="input-prepend">
	<span style="height:30px; width:25px;" class="add-on"><i class="icon-lock icon-2x"></i></span><input type="password" style="height:40px;" name="password" Placeholder="Password" required/><br>
		...
		<div class="qwe">
		 ...
		 <br>
		 <br>
<form action="logintwo.php" method="post">
	<STYLE>
		<p.double{border-style:double;}
		</style>

			<font style=" font:bold 44px 'Aleo'; text-shadow:1px 1px 15px #000; color:#fff;"><center>Employee login</center></font>
		<br>
