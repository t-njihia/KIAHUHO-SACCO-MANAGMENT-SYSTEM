...
<div class="container-fluid">
	...
	<div class="contentheader">
			<i class="icon-group"></i>Shareholders
			</div>
			<ul class="breadcrumb">
...
<?php 
			include('../connect.php');
				$result = $db->prepare("SELECT * FROM accounts ORDER BY customer_id DESC");
				$result->execute();
...
<a rel="facebox" href="addcustomer.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;" /><i class="icon-plus-sign icon-large"></i> Add Member</button></a><br><br>
