...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<?php
				include('../connect.php');
				$result = $db->prepare("SELECT * FROM employeee ORDER BY empid DESC");
				$result->execute();
			...
			<td>
			<a href="#" id="<?php echo $row['empid']; ?>" class="delbutton" title="Click To Delete"><button class="btn btn-danger btn-mini"><i class="icon-trash"></i> Delete</button></a></td>
			</tr>
			<?php
				}
			?>
