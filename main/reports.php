...
$totalSShares = $totalSaving / $CountAccounts;
			...
			Kiahuho Sacco Member Reports <font color="green" style="font:bold 22px 'Aleo';"></font>
			</div>
</div>
<input type="text" name="filter" style="padding:15px;" id="filter" placeholder="Search Member..." autocomplete="off" />
<Button type="submit" onclick="window.print()" name = "submit"  class="btn btn-danger" style="float:right; width:230px; height:35px;" /><i class="icon-print icon-large"></i> Print Report </button><br>
<br><br>
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	<thead>
		<tr>
			...
			<th width=""> Loan</th>
			<th width=""> Date Requested </th>
			<th width=""> Date Due </th>
			<th width=""> Loan Status </th>
			<th width=""> Shares </th>
	...
	<tbody>
			...
			<?php
				...
				$result = $db->prepare("select * from tbl_loansapplication
								...
								LEFT JOIN tbl_savings ON tbl_loansapplication.customer_id = tbl_savings.customer_id
								...
								LEFT JOIN tbl_loans on loan_application_details.loan_id =  tbl_loans.loan_id ORDER BY tbl_loansapplication.tbl_loansapplication_id");
				$result->execute();
